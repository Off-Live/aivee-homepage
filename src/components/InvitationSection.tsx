...
const InvitationSection: React.FC = () => {
  return (
    <section className="flex justify-center items-center w-full my-[6.25rem] py-44 max-md:max-w-full max-md:py-0 max-md:px-0 max-md:mb-[8.75rem]">
